{{-- ====================================================================== --}}
{{-- INI ADALAH ISI UNTUK FILE resources/views/layouts/partials/topbar.blade.php --}}
{{-- ====================================================================== --}}
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    {{-- Form Pencarian (saat ini dinonaktifkan dengan komentar) --}}
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    {{ auth()->user()->name }}
                    <br>
                    {{-- Menampilkan nama Role dengan rapi --}}
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                {{-- PENTING: Link ini hanya memicu Modal, bukan melakukan logout secara langsung --}}
